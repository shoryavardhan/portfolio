...
<head>
    ...
    <title>Easing Curves in Depth - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Easing Curves in Depth</h1>
...
<article>
    <p>Shifty supports a number of easing formulas, which you can see in
<a href="easing-functions.js.html"><code>easing-functions.js</code></a>.  You can add new easing
formulas by attaching methods to <a href="shifty.Tweenable.html#.formulas"><code>shifty.Tweenable.formulas</code></a>.</p>
<h2>Using multiple easing formulas</h2>
<p>Shifty supports tweens that have different easing formulas for each property.
...
straight line.  You can make curves!  To do this, simply supply <code>easing</code> as an
Object, rather than a string:</p>
<pre class="prettyprint source lang-javascript"><code>tween({
  from: {
    x: 0,
    y: 0
  },
...
<p><a href="shifty.html#.interpolate"><code>shifty.interpolate</code></a> also supports both string and object parameters for
<code>easing</code>.</p>
<h2>Per-tween custom easing functions</h2>
<p>You are not limited to attaching functions to <a href="shifty.Tweenable.html#.formulas"><code>shifty.Tweenable.formulas</code></a>.  You can also supply a custom easing function
directly to <a href="shifty.html#.tween"><code>shifty.tween</code></a>:</p>
<pre class="prettyprint source lang-javascript"><code>tween({
  from: {
    x: 0,
    y: 0
...
<p>Or even an Object of mixed strings and functions:</p>
<pre class="prettyprint source lang-javascript"><code>tween({
  from: {
    x: 0,
    y: 0
