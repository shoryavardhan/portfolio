...
<head>
    ...
    <title>tweenable.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">tweenable.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import * as easingFunctions from './easing-functions'
